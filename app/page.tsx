  ...
  return(
   ...
   <main className='container max-w-2xl px-6 py-6 mx-auto'>
    <section className='py-3'>
      ...
      <h2 className="text-4xl font-bold">{currencyFormatter("USD", 1000000)}</h2>
    </section>
    ...
    <section>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <ExpenseCategoryItem color={expense.color} title={expense.title} amount={expense.total} key={expense.id}/>
        )}
      </div>
    </section>
